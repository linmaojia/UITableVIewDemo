...
@interface DEMO7_VC ()<UITableViewDelegate, UITableViewDataSource>
{
    CGFloat _scale;
}
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    if (scrollView.contentOffset.y < 0) {
        ...
        CGFloat changeRate = self.view.jk_width / self.view.jk_height;
        CGFloat iconOriginalX = (SCREEN_WIDTH - icon_w) / 2;
        CGFloat iconOriginalY = (personBgImgHeight - icon_w) / 2;
        /*
          如果是下拉背景拉长，头像变大 纵坐标为： iconOriginalY + offsetY * changeRate * 2
         */
        self.personIconImg.frame = CGRectMake(iconOriginalX + offsetY * changeRate, iconOriginalY, icon_w - changeRate * offsetY * 2,icon_w - changeRate * offsetY * 2);
        
        self.personIconImg.layer.cornerRadius = self.personIconImg.frame.size.width * 0.5;
        self.personIconImg.clipsToBounds = YES;
